...
- (void) buyFeature:(NSString*) featureId
{
	...
	{
		UIAlertView *alert = [[UIAlertView alloc] initWithTitle:[langSetting localizedString:@"Review request approved"]
														message:[langSetting localizedString:@"You can use this feature for reviewing the app."]
													   delegate:self 
											  cancelButtonTitle:[langSetting localizedString:@"Dismiss"]
	...
	{
		UIAlertView *alert = [[UIAlertView alloc] initWithTitle:[langSetting localizedString:@"In-App Purchasing disabled"]
														message:[langSetting localizedString:@"Check your parental control settings and try again later"]
													   delegate:self 
											  cancelButtonTitle:[langSetting localizedString:@"Dismiss"]
											  otherButtonTitles: nil];
		[alert show];
